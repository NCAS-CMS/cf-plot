...
# print('read in data')
wl = NetCDFFile(
    "/home/swsheaps/cfplot.src/cfplot/wanglinho_clim_glosea_testhighvals.nc"
)
...
cfp.con(
    f=index_startdates_plusoffset, x=wl_lon, y=wl_lat, lines=False, ptype=1
)
cfp.gpos(2)
index_startdates_plusoffset = index_startdates_plusoffset - 1
cfp.con(
    f=index_startdates_plusoffset,
    x=wl_lon,
    y=wl_lat,
    lines=False,
    ptype=1,
