...
data_interp = cfp.regrid(
    f=data, x=lons, y=lats, xnew=lons_interp, ynew=lats_interp
)
...
cfp.lineplot(
    y=data_interp,
    x=lons_interp,
    title="Interpolated transect",
    xticks=np.arange(7) * 30,
    xticklabels=["0", "30E", "60E", "90E", "120E", "150E", "180E"],
    yticks=np.arange(10) * 2 - 8,
    xlabel="longitude",
    ylabel="eastward wind (ms-1)",
)
cfp.gclose()
